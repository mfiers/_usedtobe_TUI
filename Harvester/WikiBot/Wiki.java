...
public class Wiki implements Serializable
{
    ...
    private String scriptPath = ""; // need this for sites like partyvan.info
    ...
    private String useragent = "TuiBot [Wiki.java " + version + "]";
    ...
    public boolean userExists(String username) throws IOException
    {
        ...
        return !fetch(query + "action=query&list=users&ususers=" + username, "userExists", false).contains("missing=\"\"");
    }
