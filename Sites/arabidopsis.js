...
function loadTair()
{
    ...
    {
        case "gene" : idPfx = "tairg"; break;
        case "locus" : idPfx = "tairl"; break;
        case "aa_sequence" : idPfx = "tairp"; break;
    }
...
function getElementToInject()
{
    ...
    switch(TUI.getTuiMeta(TUI.META_TUI_TYPE))
    {
        ...
        case "gene" : el = findTargetId('Gene Model: '); break;
        case "locus": el = findTargetId('Locus: '); break;
        case "aa_sequence": el = findTargetId('Protein: '); break;
    }
    return el;
}
