...
var TUI = {
	...
	createTuiLike: function() {
		...
		return sprintf(TUI_LIKE_FORMAT, name, id);
	},
...
var TUIServiceProvider = {
	...
	postMessage: function(message) {
		...
		switch(provider)
		{
			case SP_Twitter: TUIServiceProvider._postMessageTwitter(message); break;
			case SP_Identica: TUIServiceProvider._postMessageIdentica(message); break;
	...
	_postMessageTwitter: function(message) {
		var newwindow=window.open(TWITTER_POPUP_TWEET_URL + encodeURIComponent(message) ,
